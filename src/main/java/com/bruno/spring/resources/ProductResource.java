...
import com.bruno.spring.dto.ProductDTO;
import com.bruno.spring.resources.utils.URL;
...
public class ProductResource {
	...
	public ResponseEntity<Page<ProductDTO>> search(
		...
		Page<Product> list = productService.search(nameDecode, ids, page, linesPerPage, orderBy, direction);
